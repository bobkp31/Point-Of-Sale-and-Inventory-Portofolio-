...
class CreateDiskonMinimumItemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_diskon_minimum_item', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tb_diskon_minimum_item');
    }
}

  ...
  <div class="col-md-8">
    <div class="table table-responsive">
      <table class="table table-bordered table-hover">
        <h3>Pengiriman <span id="hari">{{$hari}}</span></h3>
        <tr>
...
<script type="text/javascript">
  ...
  {
    var hari = $('#hari').val();
     var page = window.open('/inventory/laporan/cetakLaporanPengirimanHarian/'+hari+'','popupwindow','scrollbars=yes, width=750,height=600');
     page.print();
  }
